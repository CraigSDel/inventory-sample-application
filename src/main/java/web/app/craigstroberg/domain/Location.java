...
public class Location implements Serializable {
    ...
    public Location dateAdded(Instant dateAdded) {
    ...
    public Location lastModified(Instant lastModified) {
    ...
    public void setFarms(Set<Farm> farms) {
        if (this.farms != null) {
            this.farms.forEach(i -> i.setLocation(null));
        }
        if (farms != null) {
            farms.forEach(i -> i.setLocation(this));
        }
        this.farms = farms;
    }
