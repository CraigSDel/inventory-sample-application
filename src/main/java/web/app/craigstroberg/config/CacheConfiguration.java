package web.app.craigstroberg.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, web.app.craigstroberg.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, web.app.craigstroberg.repository.UserRepository.USERS_BY_EMAIL_CACHE);
