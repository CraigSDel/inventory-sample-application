...
/**
 * REST controller for managing {@link web.app.craigstroberg.domain.Location}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Location> partialUpdateLocation(
        ...
        Optional<Location> result = locationRepository
            ...
            .map(existingLocation -> {
                ...
                if (location.getDateAdded() != null) {
                    existingLocation.setDateAdded(location.getDateAdded());
                }
                if (location.getLastModified() != null) {
                    existingLocation.setLastModified(location.getLastModified());
                }
