...
/**
 * REST controller for managing {@link web.app.craigstroberg.domain.Country}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Country> partialUpdateCountry(
        ...
        Optional<Country> result = countryRepository
            ...
            .map(existingCountry -> {
                ...
                if (country.getDateAdded() != null) {
                    existingCountry.setDateAdded(country.getDateAdded());
                }
                if (country.getLastModified() != null) {
                    existingCountry.setLastModified(country.getLastModified());
                }
