...
describe('Country e2e test', () => {
  ...
  it('should load Countries', async () => {
    ...
    expect(await countryComponentsPage.getTitle()).to.eq('inventorySampleApplicationApp.country.home.title');
  ...
  it('should load create Country page', async () => {
    ...
    expect(await countryUpdatePage.getPageTitle()).to.eq('inventorySampleApplicationApp.country.home.createOrEditLabel');
  ...
  it('should create and save Countries', async () => {
    ...
    await promise.all([
      ...
      countryUpdatePage.setDateAddedInput('01/01/2001' + protractor.Key.TAB + '02:30AM'),
      countryUpdatePage.setLastModifiedInput('01/01/2001' + protractor.Key.TAB + '02:30AM'),
    ]);
  ...
  it('should delete last Country', async () => {
    ...
    expect(await countryDeleteDialog.getDialogTitle()).to.eq('inventorySampleApplicationApp.country.delete.question');
