...
class SemenResourceIT {
    ...
    public static Semen createEntity(EntityManager em) {
        Semen semen = new Semen().receivedDate(DEFAULT_RECEIVED_DATE).status(DEFAULT_STATUS).lastModified(DEFAULT_LAST_MODIFIED);
        return semen;
    }
    ...
    public static Semen createUpdatedEntity(EntityManager em) {
        Semen semen = new Semen().receivedDate(UPDATED_RECEIVED_DATE).status(UPDATED_STATUS).lastModified(UPDATED_LAST_MODIFIED);
        return semen;
    }
    ...
    void putNewSemen() throws Exception {
        ...
        updatedSemen.receivedDate(UPDATED_RECEIVED_DATE).status(UPDATED_STATUS).lastModified(UPDATED_LAST_MODIFIED);
    ...
    void partialUpdateSemenWithPatch() throws Exception {
        ...
        partialUpdatedSemen.receivedDate(UPDATED_RECEIVED_DATE).status(UPDATED_STATUS).lastModified(UPDATED_LAST_MODIFIED);
