...
class FarmResourceIT {
    ...
    void putNewFarm() throws Exception {
        ...
        updatedFarm.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).dateAdded(UPDATED_DATE_ADDED).lastModified(UPDATED_LAST_MODIFIED);
    ...
    void partialUpdateFarmWithPatch() throws Exception {
        ...
        partialUpdatedFarm.description(UPDATED_DESCRIPTION).dateAdded(UPDATED_DATE_ADDED);
