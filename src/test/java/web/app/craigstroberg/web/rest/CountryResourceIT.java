...
import web.app.craigstroberg.repository.CountryRepository;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().countryName(DEFAULT_COUNTRY_NAME).dateAdded(DEFAULT_DATE_ADDED).lastModified(DEFAULT_LAST_MODIFIED);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().countryName(UPDATED_COUNTRY_NAME).dateAdded(UPDATED_DATE_ADDED).lastModified(UPDATED_LAST_MODIFIED);
        return country;
    }
    ...
    void createCountry() throws Exception {
        ...
        assertThat(testCountry.getDateAdded()).isEqualTo(DEFAULT_DATE_ADDED);
        assertThat(testCountry.getLastModified()).isEqualTo(DEFAULT_LAST_MODIFIED);
    }
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.countryName(UPDATED_COUNTRY_NAME).dateAdded(UPDATED_DATE_ADDED).lastModified(UPDATED_LAST_MODIFIED);
        ...
        assertThat(testCountry.getDateAdded()).isEqualTo(UPDATED_DATE_ADDED);
        assertThat(testCountry.getLastModified()).isEqualTo(UPDATED_LAST_MODIFIED);
    }
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.countryName(UPDATED_COUNTRY_NAME).dateAdded(UPDATED_DATE_ADDED).lastModified(UPDATED_LAST_MODIFIED);
