...
import web.app.craigstroberg.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getDateAdded()).isEqualTo(DEFAULT_DATE_ADDED);
        assertThat(testLocation.getLastModified()).isEqualTo(DEFAULT_LAST_MODIFIED);
    }
    ...
    void putNewLocation() throws Exception {
        ...
        assertThat(testLocation.getDateAdded()).isEqualTo(UPDATED_DATE_ADDED);
        assertThat(testLocation.getLastModified()).isEqualTo(UPDATED_LAST_MODIFIED);
    }
